...
**RHNSW_SQ** is a variant index type combining SQ and HNSW. It firstly uses SQ to quantize the vector, then uses HNSW to quantize the SQ quantization result to get the index.
